...
namespace phoenix::character
{
    namespace
    {
        ...
        // Default weapon/shield attach-bone indices per character prefix, recovered
        // from the retail skeletons. Archer/ranger/hunter classes route ranged
        // weapons (bow/crossbow/javelin) to a separate bone. The UI can still
        // override these live; they are re-applied on every (re)load.
